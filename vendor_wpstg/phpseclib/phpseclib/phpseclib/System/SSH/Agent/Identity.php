 ...
 */
namespace WPStaging\Vendor\phpseclib\System\SSH\Agent;
...
class Identity
{
    ...
    function sign($message)
    {
        ...
        $packet = \pack('CNa*Na*N', \WPStaging\Vendor\phpseclib\System\SSH\Agent::SSH_AGENTC_SIGN_REQUEST, \strlen($this->key_blob), $this->key_blob, \strlen($message), $message, $this->flags);
        ...
        if ($type != \WPStaging\Vendor\phpseclib\System\SSH\Agent::SSH_AGENT_SIGN_RESPONSE) {
