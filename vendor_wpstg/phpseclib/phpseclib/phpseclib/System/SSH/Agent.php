 ...
 */
namespace WPStaging\Vendor\phpseclib\System\SSH;

use WPStaging\Vendor\phpseclib\Crypt\RSA;
use WPStaging\Vendor\phpseclib\System\SSH\Agent\Identity;
/**
...
class Agent
{
    ...
    function requestIdentities()
    {
        ...
        for ($i = 0; $i < $keyCount; $i++) {
            ...
            if (isset($key)) {
                $identity = new \WPStaging\Vendor\phpseclib\System\SSH\Agent\Identity($this->fsock);
