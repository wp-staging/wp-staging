 ...
 */
namespace WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Reductions;

use WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath;
use WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Base;
/**
 * PHP Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath\Base
{
    /**
     ...
     */
    protected static function generateCustomReduction(\WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $m, $class)
    {
        $m_length = \strlen($m);
        if ($m_length < 5) {
