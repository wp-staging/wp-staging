 ...
 */
namespace WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Power Of Two Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class PowerOfTwo extends \WPStaging\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
