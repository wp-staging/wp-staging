 ...
 * @access  public
 */
class DES extends \WPStaging\Vendor\phpseclib\Crypt\Base
{
    /**#@+
     * @access private
    ...
    function _setupKey()
    {
        ...
        for ($des_round = 0; $des_round < $this->des_rounds; ++$des_round) {
            ...
            $t = \unpack('Nl/Nr', $key);
            list($l, $r) = array($t['l'], $t['r']);
            $key = $this->shuffle[$pc1map[$r & 0xff]] & "€€€€€€€\0" | $this->shuffle[$pc1map[$r >> 8 & 0xff]] & "@@@@@@@\0" | $this->shuffle[$pc1map[$r >> 16 & 0xff]] & "       \0" | $this->shuffle[$pc1map[$r >> 24 & 0xff]] & "\20\20\20\20\20\20\20\0" | $this->shuffle[$pc1map[$l & 0xff]] & "\10\10\10\10\10\10\10\0" | $this->shuffle[$pc1map[$l >> 8 & 0xff]] & "\4\4\4\4\4\4\4\0" | $this->shuffle[$pc1map[$l >> 16 & 0xff]] & "\2\2\2\2\2\2\2\0" | $this->shuffle[$pc1map[$l >> 24 & 0xff]] & "\1\1\1\1\1\1\1\0";
