...
use WPStaging\Vendor\phpseclib3\Crypt\EC\Curves\Curve448;
...
use WPStaging\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
...
use WPStaging\Vendor\phpseclib3\Exception\BadConfigurationException;
        ...
        switch ($curveName) {
            case 'Ed25519':
                $providers = [
                    ...
                    'OpenSSL' => \defined('WPStaging\\Vendor\\OPENSSL_KEYTYPE_ED25519'),
                ];
                break;
            case 'Ed448':
                // OPENSSL_KEYTYPE_ED448 introduced in PHP 8.4.0
                $providers = ['OpenSSL' => \defined('WPStaging\\Vendor\\OPENSSL_KEYTYPE_ED448')];
                break;
            case 'Curve25519':
                $providers = [
                    'libsodium' => \function_exists('sodium_crypto_box_publickey_from_secretkey'),
                    // OPENSSL_KEYTYPE_X25519 introduced in PHP 8.4.0
                    'OpenSSL' => \defined('WPStaging\\Vendor\\OPENSSL_KEYTYPE_X25519'),
                ];
            // OPENSSL_KEYTYPE_X448 introduced in PHP 8.4.0
            case 'Curve448':
                $providers = ['OpenSSL' => \defined('WPStaging\\Vendor\\OPENSSL_KEYTYPE_X448')];
                break;
            default:
