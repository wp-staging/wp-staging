 ...
 * @access  public
 */
class Blowfish extends \WPStaging\Vendor\phpseclib\Crypt\Base
{
    /**
    ...
    function bcrypt_pbkdf($pass, $salt, $keylen, $rounds)
    {
        ...
        if (!isset($this->sha512)) {
            $this->sha512 = new \WPStaging\Vendor\phpseclib\Crypt\Hash('sha512');
        }
    ...
    function _encryptBlock($in)
    {
        ...
        $l = $in[1];
        $r = $in[2];
        list($r, $l) = CRYPT_BASE_USE_REG_INTVAL ? $this->_encryptBlockHelperFast($l, $r, $sb_0, $sb_1, $sb_2, $sb_3, $p) : $this->_encryptBlockHelperSlow($l, $r, $sb_0, $sb_1, $sb_2, $sb_3, $p);
        return \pack("N*", $r, $l);
    }
    /**
