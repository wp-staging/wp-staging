...
abstract class AdministrationDomainName
{
    const MAP = [
        ...
        'cast' => 2,
        'children' => ['numeric' => ['type' => \WPStaging\Vendor\phpseclib3\File\ASN1::TYPE_NUMERIC_STRING], 'printable' => ['type' => \WPStaging\Vendor\phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING]],
    ];
}
