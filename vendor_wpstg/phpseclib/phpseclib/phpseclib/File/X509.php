 ...
 */
namespace WPStaging\Vendor\phpseclib3\File;
...
use WPStaging\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use WPStaging\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use WPStaging\Vendor\phpseclib3\File\ASN1\Element;
...
class X509
{
    ...
    public function sign(\WPStaging\Vendor\phpseclib3\File\X509 $issuer, \WPStaging\Vendor\phpseclib3\File\X509 $subject)
    {
        ...
        if (isset($subject->domains) && \count($subject->domains)) {
            $altName = \array_map(['\\WPStaging\\Vendor\\phpseclib3\\File\\X509', 'dnsName'], $subject->domains);
        }
