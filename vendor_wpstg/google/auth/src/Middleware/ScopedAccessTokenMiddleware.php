...
use WPStaging\Vendor\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \WPStaging\Vendor\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
