 ...
 */
use WPStaging\Vendor\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \WPStaging\Vendor\Google\Auth\CredentialsLoader implements \WPStaging\Vendor\Google\Auth\SignBlobInterface, \WPStaging\Vendor\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \WPStaging\Vendor\google\appengine\api\app_identity\AppIdentityService::getAccessToken($scope);
    ...
    {
        $this->checkAppEngineContext();
        return \base64_encode(\WPStaging\Vendor\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHander = null)
    {
        ...
        return \WPStaging\Vendor\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        $this->checkAppEngineContext();
        if (!$this->clientName) {
            $this->clientName = \WPStaging\Vendor\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('WPStaging\\Vendor\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
