 ...
 */
class UserRefreshCredentials extends \WPStaging\Vendor\Google\Auth\CredentialsLoader implements \WPStaging\Vendor\Google\Auth\GetQuotaProjectInterface
{
    /**
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->auth = new \WPStaging\Vendor\Google\Auth\OAuth2(['clientId' => $jsonKey['client_id'], 'clientSecret' => $jsonKey['client_secret'], 'refresh_token' => $jsonKey['refresh_token'], 'scope' => $scope, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI]);
