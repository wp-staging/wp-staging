 ...
 */
class FetchAuthTokenCache implements \WPStaging\Vendor\Google\Auth\FetchAuthTokenInterface, \WPStaging\Vendor\Google\Auth\GetQuotaProjectInterface, \WPStaging\Vendor\Google\Auth\SignBlobInterface, \WPStaging\Vendor\Google\Auth\ProjectIdProviderInterface, \WPStaging\Vendor\Google\Auth\UpdateMetadataInterface
{
    use CacheTrait;
    /**
     ...
     */
    public function __construct(\WPStaging\Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, array $cacheConfig = null, \WPStaging\Vendor\Psr\Cache\CacheItemPoolInterface $cache)
    {
    ...
    {
        if (!$this->fetcher instanceof \WPStaging\Vendor\Google\Auth\SignBlobInterface) {
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        ...
        if ($this->fetcher instanceof \WPStaging\Vendor\Google\Auth\Credentials\GCECredentials) {
    ...
    {
        if ($this->fetcher instanceof \WPStaging\Vendor\Google\Auth\GetQuotaProjectInterface) {
    ...
    {
        if (!$this->fetcher instanceof \WPStaging\Vendor\Google\Auth\ProjectIdProviderInterface) {
    ...
    {
        if (!$this->fetcher instanceof \WPStaging\Vendor\Google\Auth\UpdateMetadataInterface) {
