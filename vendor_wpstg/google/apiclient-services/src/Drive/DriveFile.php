...
class DriveFile extends \WPStaging\Vendor\Google\Collection
{
    ...
    protected $capabilitiesType = \WPStaging\Vendor\Google\Service\Drive\DriveFileCapabilities::class;
    protected $capabilitiesDataType = '';
    protected $contentHintsType = \WPStaging\Vendor\Google\Service\Drive\DriveFileContentHints::class;
    protected $contentHintsDataType = '';
    protected $contentRestrictionsType = \WPStaging\Vendor\Google\Service\Drive\ContentRestriction::class;
     ...
     */
    public $id;
    protected $imageMediaMetadataType = \WPStaging\Vendor\Google\Service\Drive\DriveFileImageMediaMetadata::class;
     ...
     */
    public $kind;
    protected $lastModifyingUserType = \WPStaging\Vendor\Google\Service\Drive\User::class;
    protected $lastModifyingUserDataType = '';
    protected $linkShareMetadataType = \WPStaging\Vendor\Google\Service\Drive\DriveFileLinkShareMetadata::class;
     ...
     */
    public $ownedByMe;
    protected $ownersType = \WPStaging\Vendor\Google\Service\Drive\User::class;
    ...
    protected $permissionsType = \WPStaging\Vendor\Google\Service\Drive\Permission::class;
    ...
    protected $sharingUserType = \WPStaging\Vendor\Google\Service\Drive\User::class;
    protected $sharingUserDataType = '';
    protected $shortcutDetailsType = \WPStaging\Vendor\Google\Service\Drive\DriveFileShortcutDetails::class;
     ...
     */
    public $trashedTime;
    protected $trashingUserType = \WPStaging\Vendor\Google\Service\Drive\User::class;
    protected $trashingUserDataType = '';
    /**
     * @var string
     */
    public $version;
    protected $videoMediaMetadataType = \WPStaging\Vendor\Google\Service\Drive\DriveFileVideoMediaMetadata::class;
     ...
     */
    public function setCapabilities(\WPStaging\Vendor\Google\Service\Drive\DriveFileCapabilities $capabilities)
    {
     ...
     */
    public function setContentHints(\WPStaging\Vendor\Google\Service\Drive\DriveFileContentHints $contentHints)
    {
     ...
     */
    public function setImageMediaMetadata(\WPStaging\Vendor\Google\Service\Drive\DriveFileImageMediaMetadata $imageMediaMetadata)
    {
     ...
     * @param User
     */
    public function setLastModifyingUser(\WPStaging\Vendor\Google\Service\Drive\User $lastModifyingUser)
    {
     ...
     */
    public function setLinkShareMetadata(\WPStaging\Vendor\Google\Service\Drive\DriveFileLinkShareMetadata $linkShareMetadata)
    {
     ...
     * @param User
     */
    public function setSharingUser(\WPStaging\Vendor\Google\Service\Drive\User $sharingUser)
    {
     ...
     */
    public function setShortcutDetails(\WPStaging\Vendor\Google\Service\Drive\DriveFileShortcutDetails $shortcutDetails)
    {
     ...
     * @param User
     */
    public function setTrashingUser(\WPStaging\Vendor\Google\Service\Drive\User $trashingUser)
    {
     ...
     */
    public function setVideoMediaMetadata(\WPStaging\Vendor\Google\Service\Drive\DriveFileVideoMediaMetadata $videoMediaMetadata)
    {
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\DriveFile::class, 'WPStaging\\Vendor\\Google_Service_Drive_DriveFile');
