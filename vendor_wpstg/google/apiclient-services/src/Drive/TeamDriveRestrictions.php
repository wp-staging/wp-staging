...
class TeamDriveRestrictions extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\TeamDriveRestrictions::class, 'WPStaging\\Vendor\\Google_Service_Drive_TeamDriveRestrictions');
