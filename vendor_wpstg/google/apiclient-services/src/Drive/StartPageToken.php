...
class StartPageToken extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\StartPageToken::class, 'WPStaging\\Vendor\\Google_Service_Drive_StartPageToken');
