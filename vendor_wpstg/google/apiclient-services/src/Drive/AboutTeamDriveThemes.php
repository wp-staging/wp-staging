...
class AboutTeamDriveThemes extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\AboutTeamDriveThemes::class, 'WPStaging\\Vendor\\Google_Service_Drive_AboutTeamDriveThemes');
