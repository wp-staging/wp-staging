...
class DriveFileShortcutDetails extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\DriveFileShortcutDetails::class, 'WPStaging\\Vendor\\Google_Service_Drive_DriveFileShortcutDetails');
