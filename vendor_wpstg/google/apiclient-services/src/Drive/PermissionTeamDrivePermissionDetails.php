...
class PermissionTeamDrivePermissionDetails extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\PermissionTeamDrivePermissionDetails::class, 'WPStaging\\Vendor\\Google_Service_Drive_PermissionTeamDrivePermissionDetails');
