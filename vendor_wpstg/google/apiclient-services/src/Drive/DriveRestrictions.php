...
class DriveRestrictions extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\DriveRestrictions::class, 'WPStaging\\Vendor\\Google_Service_Drive_DriveRestrictions');
