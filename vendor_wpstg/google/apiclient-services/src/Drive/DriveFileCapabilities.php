...
class DriveFileCapabilities extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\DriveFileCapabilities::class, 'WPStaging\\Vendor\\Google_Service_Drive_DriveFileCapabilities');
