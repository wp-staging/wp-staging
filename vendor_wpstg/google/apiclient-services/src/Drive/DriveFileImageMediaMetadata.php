...
class DriveFileImageMediaMetadata extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var float
     */
     ...
     */
    public $lens;
    protected $locationType = \WPStaging\Vendor\Google\Service\Drive\DriveFileImageMediaMetadataLocation::class;
     ...
     */
    public function setLocation(\WPStaging\Vendor\Google\Service\Drive\DriveFileImageMediaMetadataLocation $location)
    {
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\DriveFileImageMediaMetadata::class, 'WPStaging\\Vendor\\Google_Service_Drive_DriveFileImageMediaMetadata');
