...
class Permission extends \WPStaging\Vendor\Google\Collection
{
     ...
     */
    public $pendingOwner;
    protected $permissionDetailsType = \WPStaging\Vendor\Google\Service\Drive\PermissionPermissionDetails::class;
     ...
     */
    public $role;
    protected $teamDrivePermissionDetailsType = \WPStaging\Vendor\Google\Service\Drive\PermissionTeamDrivePermissionDetails::class;
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Permission::class, 'WPStaging\\Vendor\\Google_Service_Drive_Permission');
