...
class About extends \WPStaging\Vendor\Google\Collection
{
    ...
    protected $driveThemesType = \WPStaging\Vendor\Google\Service\Drive\AboutDriveThemes::class;
    ...
    protected $storageQuotaType = \WPStaging\Vendor\Google\Service\Drive\AboutStorageQuota::class;
    protected $storageQuotaDataType = '';
    protected $teamDriveThemesType = \WPStaging\Vendor\Google\Service\Drive\AboutTeamDriveThemes::class;
    protected $teamDriveThemesDataType = 'array';
    protected $userType = \WPStaging\Vendor\Google\Service\Drive\User::class;
     ...
     */
    public function setStorageQuota(\WPStaging\Vendor\Google\Service\Drive\AboutStorageQuota $storageQuota)
    {
     ...
     * @param User
     */
    public function setUser(\WPStaging\Vendor\Google\Service\Drive\User $user)
    {
        $this->user = $user;
    }
    /**
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\About::class, 'WPStaging\\Vendor\\Google_Service_Drive_About');
