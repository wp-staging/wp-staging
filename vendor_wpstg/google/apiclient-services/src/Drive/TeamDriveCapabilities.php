...
class TeamDriveCapabilities extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\TeamDriveCapabilities::class, 'WPStaging\\Vendor\\Google_Service_Drive_TeamDriveCapabilities');
