...
use WPStaging\Vendor\Google\Service\Drive\Revision;
use WPStaging\Vendor\Google\Service\Drive\RevisionList;
/**
 ...
 *  </code>
 */
class Revisions extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($fileId, $revisionId, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\Drive\Revision::class);
    }
    /**
    ...
    public function listRevisions($fileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\RevisionList::class);
    }
    /**
     ...
     * @return Revision
     */
    public function update($fileId, $revisionId, \WPStaging\Vendor\Google\Service\Drive\Revision $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\Drive\Revision::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Revisions::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Revisions');
