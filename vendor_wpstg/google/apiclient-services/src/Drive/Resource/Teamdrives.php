...
use WPStaging\Vendor\Google\Service\Drive\TeamDrive;
use WPStaging\Vendor\Google\Service\Drive\TeamDriveList;
/**
 ...
 *  </code>
 */
class Teamdrives extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return TeamDrive
     */
    public function create($requestId, \WPStaging\Vendor\Google\Service\Drive\TeamDrive $postBody, $optParams = [])
    {
        $params = ['requestId' => $requestId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \WPStaging\Vendor\Google\Service\Drive\TeamDrive::class);
    }
    /**
    ...
    public function get($teamDriveId, $optParams = [])
    {
        $params = ['teamDriveId' => $teamDriveId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\Drive\TeamDrive::class);
    }
    /**
    ...
    public function listTeamdrives($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\TeamDriveList::class);
    }
    /**
     ...
     * @return TeamDrive
     */
    public function update($teamDriveId, \WPStaging\Vendor\Google\Service\Drive\TeamDrive $postBody, $optParams = [])
    {
        $params = ['teamDriveId' => $teamDriveId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\Drive\TeamDrive::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Teamdrives::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Teamdrives');
