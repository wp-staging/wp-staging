...
use WPStaging\Vendor\Google\Service\Drive\Permission;
use WPStaging\Vendor\Google\Service\Drive\PermissionList;
/**
 ...
 *  </code>
 */
class Permissions extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return Permission
     */
    public function create($fileId, \WPStaging\Vendor\Google\Service\Drive\Permission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \WPStaging\Vendor\Google\Service\Drive\Permission::class);
    }
    /**
    ...
    public function get($fileId, $permissionId, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'permissionId' => $permissionId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\Drive\Permission::class);
    }
    /**
    ...
    public function listPermissions($fileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\PermissionList::class);
    }
    /**
     ...
     * @return Permission
     */
    public function update($fileId, $permissionId, \WPStaging\Vendor\Google\Service\Drive\Permission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\Drive\Permission::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Permissions::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Permissions');
