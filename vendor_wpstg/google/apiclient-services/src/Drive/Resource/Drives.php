...
use WPStaging\Vendor\Google\Service\Drive\Drive;
use WPStaging\Vendor\Google\Service\Drive\DriveList;
/**
 ...
 *  </code>
 */
class Drives extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return Drive
     */
    public function create($requestId, \WPStaging\Vendor\Google\Service\Drive\Drive $postBody, $optParams = [])
    {
        $params = ['requestId' => $requestId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \WPStaging\Vendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function get($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function hide($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('hide', [$params], \WPStaging\Vendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function listDrives($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\DriveList::class);
    }
    /**
    ...
    public function unhide($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('unhide', [$params], \WPStaging\Vendor\Google\Service\Drive\Drive::class);
    }
    /**
     ...
     * @return Drive
     */
    public function update($driveId, \WPStaging\Vendor\Google\Service\Drive\Drive $postBody, $optParams = [])
    {
        $params = ['driveId' => $driveId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\Drive\Drive::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Drives::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Drives');
