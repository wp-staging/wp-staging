...
use WPStaging\Vendor\Google\Service\Drive\ChangeList;
use WPStaging\Vendor\Google\Service\Drive\Channel;
use WPStaging\Vendor\Google\Service\Drive\StartPageToken;
/**
 ...
 *  </code>
 */
class Changes extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
    ...
    public function getStartPageToken($optParams = [])
    {
        ...
        return $this->call('getStartPageToken', [$params], \WPStaging\Vendor\Google\Service\Drive\StartPageToken::class);
    }
    /**
    ...
    public function listChanges($pageToken, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\ChangeList::class);
    }
    /**
     ...
     * @return Channel
     */
    public function watch($pageToken, \WPStaging\Vendor\Google\Service\Drive\Channel $postBody, $optParams = [])
    {
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Changes::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Changes');
