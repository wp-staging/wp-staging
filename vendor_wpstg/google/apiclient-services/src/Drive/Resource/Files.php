...
use WPStaging\Vendor\Google\Service\Drive\Channel;
use WPStaging\Vendor\Google\Service\Drive\DriveFile;
use WPStaging\Vendor\Google\Service\Drive\FileList;
use WPStaging\Vendor\Google\Service\Drive\GeneratedIds;
/**
 ...
 *  </code>
 */
class Files extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return DriveFile
     */
    public function copy($fileId, \WPStaging\Vendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('copy', [$params], \WPStaging\Vendor\Google\Service\Drive\DriveFile::class);
    }
    /**
     ...
     * @return DriveFile
     */
    public function create(\WPStaging\Vendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \WPStaging\Vendor\Google\Service\Drive\DriveFile::class);
    }
    /**
    ...
    public function generateIds($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('generateIds', [$params], \WPStaging\Vendor\Google\Service\Drive\GeneratedIds::class);
    }
    /**
    ...
    public function get($fileId, $optParams = [])
    {
        $params = ['fileId' => $fileId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\Drive\DriveFile::class);
    }
    /**
    ...
    public function listFiles($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\Drive\FileList::class);
    }
    /**
     ...
     * @return DriveFile
     */
    public function update($fileId, \WPStaging\Vendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\Drive\DriveFile::class);
    }
    /**
     ...
     * @return Channel
     */
    public function watch($fileId, \WPStaging\Vendor\Google\Service\Drive\Channel $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('watch', [$params], \WPStaging\Vendor\Google\Service\Drive\Channel::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\Drive\Resource\Files::class, 'WPStaging\\Vendor\\Google_Service_Drive_Resource_Files');
