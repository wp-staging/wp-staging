...
class AboutDriveThemes extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\AboutDriveThemes::class, 'WPStaging\\Vendor\\Google_Service_Drive_AboutDriveThemes');
