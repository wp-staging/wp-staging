...
class AboutStorageQuota extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\Drive\AboutStorageQuota::class, 'WPStaging\\Vendor\\Google_Service_Drive_AboutStorageQuota');
