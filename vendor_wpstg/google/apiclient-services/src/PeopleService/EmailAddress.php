...
class EmailAddress extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\EmailAddress::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_EmailAddress');
