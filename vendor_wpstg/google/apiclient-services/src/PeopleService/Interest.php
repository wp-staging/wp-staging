...
class Interest extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Interest::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Interest');
