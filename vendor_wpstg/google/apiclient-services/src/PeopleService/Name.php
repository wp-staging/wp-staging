...
class Name extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Name::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Name');
