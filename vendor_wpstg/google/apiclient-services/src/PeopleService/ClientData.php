...
class ClientData extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\ClientData::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_ClientData');
