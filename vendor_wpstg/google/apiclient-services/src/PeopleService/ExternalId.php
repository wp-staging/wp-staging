...
class ExternalId extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\ExternalId::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_ExternalId');
