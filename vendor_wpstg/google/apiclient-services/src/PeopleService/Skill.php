...
class Skill extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Skill::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Skill');
