...
class UpdateContactGroupRequest extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\UpdateContactGroupRequest::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_UpdateContactGroupRequest');
