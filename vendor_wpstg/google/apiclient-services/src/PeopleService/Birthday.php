...
class Birthday extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Birthday::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Birthday');
