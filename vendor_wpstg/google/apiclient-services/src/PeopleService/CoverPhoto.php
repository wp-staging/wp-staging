...
class CoverPhoto extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\CoverPhoto::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_CoverPhoto');
