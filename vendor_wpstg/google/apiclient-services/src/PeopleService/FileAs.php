...
class FileAs extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\FileAs::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_FileAs');
