...
class Location extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Location::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Location');
