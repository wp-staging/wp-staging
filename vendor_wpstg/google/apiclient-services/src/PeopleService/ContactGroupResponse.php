...
class ContactGroupResponse extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\ContactGroupResponse::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_ContactGroupResponse');
