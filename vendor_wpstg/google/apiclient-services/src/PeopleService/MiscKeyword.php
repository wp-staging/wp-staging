...
class MiscKeyword extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\MiscKeyword::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_MiscKeyword');
