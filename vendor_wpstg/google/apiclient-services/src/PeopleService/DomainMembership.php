...
class DomainMembership extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\DomainMembership::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_DomainMembership');
