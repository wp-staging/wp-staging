...
class RelationshipStatus extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\RelationshipStatus::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_RelationshipStatus');
