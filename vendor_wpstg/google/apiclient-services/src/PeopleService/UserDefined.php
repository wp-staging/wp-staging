...
class UserDefined extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\UserDefined::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_UserDefined');
