...
class Biography extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Biography::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Biography');
