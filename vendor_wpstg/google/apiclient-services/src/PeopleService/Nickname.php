...
class Nickname extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Nickname::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Nickname');
