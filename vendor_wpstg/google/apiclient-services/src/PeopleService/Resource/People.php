...
use WPStaging\Vendor\Google\Service\PeopleService\BatchCreateContactsRequest;
use WPStaging\Vendor\Google\Service\PeopleService\BatchCreateContactsResponse;
use WPStaging\Vendor\Google\Service\PeopleService\BatchDeleteContactsRequest;
use WPStaging\Vendor\Google\Service\PeopleService\BatchUpdateContactsRequest;
use WPStaging\Vendor\Google\Service\PeopleService\BatchUpdateContactsResponse;
use WPStaging\Vendor\Google\Service\PeopleService\DeleteContactPhotoResponse;
use WPStaging\Vendor\Google\Service\PeopleService\GetPeopleResponse;
use WPStaging\Vendor\Google\Service\PeopleService\ListDirectoryPeopleResponse;
use WPStaging\Vendor\Google\Service\PeopleService\PeopleEmpty;
use WPStaging\Vendor\Google\Service\PeopleService\Person;
use WPStaging\Vendor\Google\Service\PeopleService\SearchDirectoryPeopleResponse;
use WPStaging\Vendor\Google\Service\PeopleService\SearchResponse;
use WPStaging\Vendor\Google\Service\PeopleService\UpdateContactPhotoRequest;
use WPStaging\Vendor\Google\Service\PeopleService\UpdateContactPhotoResponse;
/**
 ...
 *  </code>
 */
class People extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function batchCreateContacts(\WPStaging\Vendor\Google\Service\PeopleService\BatchCreateContactsRequest $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchCreateContacts', [$params], \WPStaging\Vendor\Google\Service\PeopleService\BatchCreateContactsResponse::class);
    }
    /**
     ...
     * @return PeopleEmpty
     */
    public function batchDeleteContacts(\WPStaging\Vendor\Google\Service\PeopleService\BatchDeleteContactsRequest $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchDeleteContacts', [$params], \WPStaging\Vendor\Google\Service\PeopleService\PeopleEmpty::class);
    }
    /**
     ...
     */
    public function batchUpdateContacts(\WPStaging\Vendor\Google\Service\PeopleService\BatchUpdateContactsRequest $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdateContacts', [$params], \WPStaging\Vendor\Google\Service\PeopleService\BatchUpdateContactsResponse::class);
    }
    /**
     ...
     * @return Person
     */
    public function createContact(\WPStaging\Vendor\Google\Service\PeopleService\Person $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('createContact', [$params], \WPStaging\Vendor\Google\Service\PeopleService\Person::class);
    }
    /**
    ...
    public function deleteContact($resourceName, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('deleteContact', [$params], \WPStaging\Vendor\Google\Service\PeopleService\PeopleEmpty::class);
    }
    /**
    ...
    public function deleteContactPhoto($resourceName, $optParams = [])
    {
        $params = ['resourceName' => $resourceName];
        $params = \array_merge($params, $optParams);
        return $this->call('deleteContactPhoto', [$params], \WPStaging\Vendor\Google\Service\PeopleService\DeleteContactPhotoResponse::class);
    }
    /**
    ...
    public function get($resourceName, $optParams = [])
    {
        $params = ['resourceName' => $resourceName];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\PeopleService\Person::class);
    }
    /**
    ...
    public function getBatchGet($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('getBatchGet', [$params], \WPStaging\Vendor\Google\Service\PeopleService\GetPeopleResponse::class);
    }
    /**
    ...
    public function listDirectoryPeople($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('listDirectoryPeople', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ListDirectoryPeopleResponse::class);
    }
    /**
    ...
    public function searchContacts($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('searchContacts', [$params], \WPStaging\Vendor\Google\Service\PeopleService\SearchResponse::class);
    }
    /**
     * Provides a list of domain profiles and domain contacts in the authenticated
    ...
    public function searchDirectoryPeople($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('searchDirectoryPeople', [$params], \WPStaging\Vendor\Google\Service\PeopleService\SearchDirectoryPeopleResponse::class);
    }
    /**
     ...
     * @return Person
     */
    public function updateContact($resourceName, \WPStaging\Vendor\Google\Service\PeopleService\Person $postBody, $optParams = [])
    {
        $params = ['resourceName' => $resourceName, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('updateContact', [$params], \WPStaging\Vendor\Google\Service\PeopleService\Person::class);
    }
    /**
     ...
     */
    public function updateContactPhoto($resourceName, \WPStaging\Vendor\Google\Service\PeopleService\UpdateContactPhotoRequest $postBody, $optParams = [])
    {
        $params = ['resourceName' => $resourceName, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('updateContactPhoto', [$params], \WPStaging\Vendor\Google\Service\PeopleService\UpdateContactPhotoResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Resource\People::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Resource_People');
