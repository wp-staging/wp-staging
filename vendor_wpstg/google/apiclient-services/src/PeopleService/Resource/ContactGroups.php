...
use WPStaging\Vendor\Google\Service\PeopleService\BatchGetContactGroupsResponse;
use WPStaging\Vendor\Google\Service\PeopleService\ContactGroup;
use WPStaging\Vendor\Google\Service\PeopleService\CreateContactGroupRequest;
use WPStaging\Vendor\Google\Service\PeopleService\ListContactGroupsResponse;
use WPStaging\Vendor\Google\Service\PeopleService\PeopleEmpty;
use WPStaging\Vendor\Google\Service\PeopleService\UpdateContactGroupRequest;
/**
 ...
 *  </code>
 */
class ContactGroups extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
    ...
    public function batchGet($optParams = [])
    {
        ...
        return $this->call('batchGet', [$params], \WPStaging\Vendor\Google\Service\PeopleService\BatchGetContactGroupsResponse::class);
    }
    /**
     ...
     * @return ContactGroup
     */
    public function create(\WPStaging\Vendor\Google\Service\PeopleService\CreateContactGroupRequest $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ContactGroup::class);
    }
    /**
    ...
    public function delete($resourceName, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', [$params], \WPStaging\Vendor\Google\Service\PeopleService\PeopleEmpty::class);
    }
    /**
    ...
    public function get($resourceName, $optParams = [])
    {
        $params = ['resourceName' => $resourceName];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ContactGroup::class);
    }
    /**
    ...
    public function listContactGroups($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ListContactGroupsResponse::class);
    }
    /**
     ...
     * @return ContactGroup
     */
    public function update($resourceName, \WPStaging\Vendor\Google\Service\PeopleService\UpdateContactGroupRequest $postBody, $optParams = [])
    {
        $params = ['resourceName' => $resourceName, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ContactGroup::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Resource\ContactGroups::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Resource_ContactGroups');
