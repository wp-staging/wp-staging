...
use WPStaging\Vendor\Google\Service\PeopleService\ListConnectionsResponse;
/**
 ...
 *  </code>
 */
class PeopleConnections extends \WPStaging\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listPeopleConnections($resourceName, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \WPStaging\Vendor\Google\Service\PeopleService\ListConnectionsResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Resource\PeopleConnections::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Resource_PeopleConnections');
