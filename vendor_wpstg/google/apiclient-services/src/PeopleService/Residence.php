...
class Residence extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Residence::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Residence');
