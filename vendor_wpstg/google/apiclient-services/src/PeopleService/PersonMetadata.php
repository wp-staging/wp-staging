...
class PersonMetadata extends \WPStaging\Vendor\Google\Collection
{
    ...
    protected $sourcesType = \WPStaging\Vendor\Google\Service\PeopleService\Source::class;
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\PersonMetadata::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_PersonMetadata');
