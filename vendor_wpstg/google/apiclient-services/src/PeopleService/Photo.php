...
class Photo extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Photo::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Photo');
