...
class Gender extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Gender::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Gender');
