...
class AgeRangeType extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\AgeRangeType::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_AgeRangeType');
