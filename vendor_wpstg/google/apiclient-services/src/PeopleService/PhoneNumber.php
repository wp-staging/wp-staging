...
class PhoneNumber extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\PhoneNumber::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_PhoneNumber');
