...
class RelationshipInterest extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\RelationshipInterest::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_RelationshipInterest');
