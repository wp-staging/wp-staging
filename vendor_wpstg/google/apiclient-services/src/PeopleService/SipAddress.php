...
class SipAddress extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\SipAddress::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_SipAddress');
