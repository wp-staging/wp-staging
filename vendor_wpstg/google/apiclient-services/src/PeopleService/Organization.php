...
class Organization extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
     ...
     */
    public $domain;
    protected $endDateType = \WPStaging\Vendor\Google\Service\PeopleService\Date::class;
     ...
     */
    public $phoneticName;
    protected $startDateType = \WPStaging\Vendor\Google\Service\PeopleService\Date::class;
     ...
     * @param Date
     */
    public function setEndDate(\WPStaging\Vendor\Google\Service\PeopleService\Date $endDate)
    {
     ...
     * @param Date
     */
    public function setStartDate(\WPStaging\Vendor\Google\Service\PeopleService\Date $startDate)
    {
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Organization::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Organization');
