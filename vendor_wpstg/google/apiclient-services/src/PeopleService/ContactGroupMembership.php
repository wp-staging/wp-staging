...
class ContactGroupMembership extends \WPStaging\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\ContactGroupMembership::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_ContactGroupMembership');
