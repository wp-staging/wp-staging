...
class Locale extends \WPStaging\Vendor\Google\Model
{
...
\class_alias(\WPStaging\Vendor\Google\Service\PeopleService\Locale::class, 'WPStaging\\Vendor\\Google_Service_PeopleService_Locale');
