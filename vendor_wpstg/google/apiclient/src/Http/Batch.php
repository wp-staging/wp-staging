...
EOF;
    ...
    public function parseResponse(\WPStaging\Vendor\Psr\Http\Message\ResponseInterface $response, $classes = array())
    {
        ...
        if (!empty($body)) {
            ...
            foreach ($parts as $i => $part) {
                ...
                if (!empty($part)) {
                    ...
                    $response = new \WPStaging\Vendor\GuzzleHttp\Psr7\Response($status, $partHeaders, \WPStaging\Vendor\GuzzleHttp\Psr7\Utils::streamFor($partBody));
                    // Need content id.
