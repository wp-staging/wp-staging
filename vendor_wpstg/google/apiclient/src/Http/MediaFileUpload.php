...
class MediaFileUpload
{
     ...
     */
    public function __construct(\WPStaging\Vendor\Google\Client $client, \WPStaging\Vendor\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = \false)
    {
        $this->client = $client;
