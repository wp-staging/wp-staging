...
final class Env
{
    ...
    public static function createRuntime()
    {
        switch ($compileDir = self::getEnvVariable(self::COMPILE_DIR)) {
            case \false:
                return new \WPStaging\Vendor\JmesPath\AstRuntime();
            case 'on':
                return new \WPStaging\Vendor\JmesPath\CompilerRuntime();
            default:
                return new \WPStaging\Vendor\JmesPath\CompilerRuntime($compileDir);
        }
    }
    /**
