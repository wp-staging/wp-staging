...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WPStaging\Vendor\JmesPath\Lexer();
        $this->parser = new \WPStaging\Vendor\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \WPStaging\Vendor\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \WPStaging\Vendor\JmesPath\Lexer();
    ...
    {
        $parser = new \WPStaging\Vendor\JmesPath\Parser();
