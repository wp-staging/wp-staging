...
class AstRuntime
{
    ...
    public function __construct(\WPStaging\Vendor\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \WPStaging\Vendor\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \WPStaging\Vendor\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \WPStaging\Vendor\JmesPath\Parser();
    }
    /**
