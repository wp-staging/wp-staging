...
class CompilerRuntime
{
     ...
     */
    public function __construct($dir = null, \WPStaging\Vendor\JmesPath\Parser $parser = null)
    {
        $this->parser = $parser ?: new \WPStaging\Vendor\JmesPath\Parser();
        $this->compiler = new \WPStaging\Vendor\JmesPath\TreeCompiler();
        ...
        $this->interpreter = new \WPStaging\Vendor\JmesPath\TreeInterpreter();
    }
    /**
