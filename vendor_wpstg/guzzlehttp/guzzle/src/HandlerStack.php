...
class HandlerStack
{
    ...
    public static function create(callable $handler = null)
    {
        ...
        $stack->push(\WPStaging\Vendor\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\WPStaging\Vendor\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\WPStaging\Vendor\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\WPStaging\Vendor\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
