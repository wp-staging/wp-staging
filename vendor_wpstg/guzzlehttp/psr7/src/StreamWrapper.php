...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
