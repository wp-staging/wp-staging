 ...
 * @final
 */
class FnStream implements \WPStaging\Vendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
