 ...
 * @final
 */
class AppendStream implements \WPStaging\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \WPStaging\Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
