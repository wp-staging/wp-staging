...
class QuotaManager
{
    ...
    {
        if ($result instanceof \WPStaging\Vendor\Aws\Exception\AwsException && $result->isConnectionError()) {
    ...
    public function releaseToQuota($result)
    {
        ...
        } elseif ($result instanceof \WPStaging\Vendor\Aws\ResultInterface) {
