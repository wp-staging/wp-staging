...
class Configuration implements \WPStaging\Vendor\Aws\DefaultsMode\ConfigurationInterface
{
    private $mode;
    private $retryMode;
    ...
    public function __construct($mode = 'legacy')
    {
        ...
        $data = \WPStaging\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/sdk-default-configuration.json');
