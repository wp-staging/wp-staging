 ...
 */
class AesEncryptingStream implements \WPStaging\Vendor\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $plainText, $key, \WPStaging\Vendor\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
