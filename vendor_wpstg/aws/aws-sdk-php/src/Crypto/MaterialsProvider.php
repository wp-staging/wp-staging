...
abstract class MaterialsProvider implements \WPStaging\Vendor\Aws\Crypto\MaterialsProviderInterface
{
     ...
     * @internal
     */
    public abstract function fromDecryptionEnvelope(\WPStaging\Vendor\Aws\Crypto\MetadataEnvelope $envelope);
    /**
