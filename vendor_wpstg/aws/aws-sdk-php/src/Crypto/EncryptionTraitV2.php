...
trait EncryptionTraitV2
{
    ...
    private static $encryptClasses = ['gcm' => \WPStaging\Vendor\Aws\Crypto\AesGcmEncryptingStream::class];
    /**
     ...
     * @internal
     */
    public function encrypt(\WPStaging\Vendor\GuzzleHttp\Psr7\Stream $plaintext, array $options, \WPStaging\Vendor\Aws\Crypto\MaterialsProviderV2 $provider, \WPStaging\Vendor\Aws\Crypto\MetadataEnvelope $envelope)
    {
        ...
        if (!\WPStaging\Vendor\Aws\Crypto\MaterialsProviderV2::isSupportedKeySize($cipherOptions['KeySize'])) {
        ...
        $envelope[\WPStaging\Vendor\Aws\Crypto\MetadataEnvelope::CONTENT_KEY_V2_HEADER] = $keys['Ciphertext'];
        unset($keys);
