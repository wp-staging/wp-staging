...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\WPStaging\Vendor\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\WPStaging\Vendor\GuzzleHttp\Psr7\Stream $plaintext, array $options, \WPStaging\Vendor\Aws\Crypto\MaterialsProviderV2 $provider, \WPStaging\Vendor\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \WPStaging\Vendor\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \WPStaging\Vendor\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
