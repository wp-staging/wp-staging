 ...
 */
class AwsException extends \RuntimeException implements \WPStaging\Vendor\Aws\MonitoringEventsInterface, \WPStaging\Vendor\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \WPStaging\Vendor\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
