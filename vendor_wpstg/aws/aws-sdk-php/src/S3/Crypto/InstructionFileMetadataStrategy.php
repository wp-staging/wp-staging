 ...
 */
class InstructionFileMetadataStrategy implements \WPStaging\Vendor\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\WPStaging\Vendor\Aws\S3\S3Client $client, $suffix = null)
    {
