...
use WPStaging\Vendor\Aws\Crypto\DecryptionTrait;
use WPStaging\Vendor\Aws\HashingStream;
use WPStaging\Vendor\Aws\PhpHash;
use WPStaging\Vendor\Aws\Crypto\AbstractCryptoClient;
use WPStaging\Vendor\Aws\Crypto\EncryptionTrait;
 ...
 * @deprecated
 */
class S3EncryptionClient extends \WPStaging\Vendor\Aws\Crypto\AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \WPStaging\Vendor\GuzzleHttp\Promise\Create::promiseFor($this->encrypt(\WPStaging\Vendor\GuzzleHttp\Psr7\Utils::streamFor($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
