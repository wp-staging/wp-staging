...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\WPStaging\Vendor\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\WPStaging\Vendor\Aws\Credentials\CredentialsInterface $creds)
    {
