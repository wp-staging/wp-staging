...
class InputValidationMiddleware
{
     ...
     * @return callable     */
    public static function wrap(\WPStaging\Vendor\Aws\Api\Service $service, $mandatoryAttributeList)
    {
    ...
    public function __construct(callable $nextHandler, \WPStaging\Vendor\Aws\Api\Service $service, $mandatoryAttributeList)
    {
        $this->service = $service;
        $this->nextHandler = $nextHandler;
        $this->mandatoryAttributeList = $mandatoryAttributeList;
    }
    public function __invoke(\WPStaging\Vendor\Aws\CommandInterface $cmd)
    {
