 ...
 */
class CloudFrontClient extends \WPStaging\Vendor\Aws\AwsClient
{
    /**
    ...
    public function getSignedUrl(array $options)
    {
        ...
        $urlSigner = new \WPStaging\Vendor\Aws\CloudFront\UrlSigner($options['key_pair_id'], $options['private_key']);
    ...
    public function getSignedCookie(array $options)
    {
        ...
        $cookieSigner = new \WPStaging\Vendor\Aws\CloudFront\CookieSigner($options['key_pair_id'], $options['private_key']);
