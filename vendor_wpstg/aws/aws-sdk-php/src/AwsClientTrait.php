...
trait AwsClientTrait
{
    public function getPaginator($name, array $args = [])
    {
        ...
        return new \WPStaging\Vendor\Aws\ResultPaginator($this, $name, $args, $config);
    }
    ...
    public function getWaiter($name, array $args = [])
    {
        ...
        return new \WPStaging\Vendor\Aws\Waiter($this, $name, $args, $config);
    }
    public function execute(\WPStaging\Vendor\Aws\CommandInterface $command)
    {
        return $this->executeAsync($command)->wait();
    }
    public function executeAsync(\WPStaging\Vendor\Aws\CommandInterface $command)
    {
