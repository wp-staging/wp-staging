 ...
 */
class HashingStream implements \WPStaging\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\WPStaging\Vendor\Psr\Http\Message\StreamInterface $stream, \WPStaging\Vendor\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
