 ...
 * @since 3.0.0
 */
class ActionScheduler_OptionLock extends \WPStaging\Vendor\ActionScheduler_Lock
{
    /**
    ...
    {
        return \WPStaging\Vendor\update_option($this->get_key($lock_type), \time() + $this->get_duration($lock_type));
    }
    /**
    ...
    {
        return \WPStaging\Vendor\get_option($this->get_key($lock_type));
    }
    /**
