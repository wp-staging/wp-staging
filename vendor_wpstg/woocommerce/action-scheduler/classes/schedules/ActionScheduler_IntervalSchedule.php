 ...
 */
class ActionScheduler_IntervalSchedule extends \WPStaging\Vendor\ActionScheduler_Abstract_RecurringSchedule implements \WPStaging\Vendor\ActionScheduler_Schedule
{
    /**
     ...
     * Deprecated property @see $this->__wakeup() for details.
     **/
    private $interval_in_seconds = \WPStaging\Vendor\NULL;
    /**
    ...
    {
        \WPStaging\Vendor\_deprecated_function(__METHOD__, '3.0.0', '(int)ActionScheduler_Abstract_RecurringSchedule::get_recurrence()');
    ...
    public function __sleep()
    {
        ...
        return \array_merge($sleep_params, array('start_timestamp', 'interval_in_seconds'));
    }
    /**
