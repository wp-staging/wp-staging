 ...
 */
class ActionScheduler_SimpleSchedule extends \WPStaging\Vendor\ActionScheduler_Abstract_Schedule
{
    /**
     * Deprecated property @see $this->__wakeup() for details.
     **/
    private $timestamp = \WPStaging\Vendor\NULL;
    /**
    ...
    public function __sleep()
    {
        ...
        return \array_merge($sleep_params, array('timestamp'));
    }
    /**
