 ...
 */
class ActionScheduler_CronSchedule extends \WPStaging\Vendor\ActionScheduler_Abstract_RecurringSchedule implements \WPStaging\Vendor\ActionScheduler_Schedule
{
    /**
     * Deprecated property @see $this->__wakeup() for details.
     **/
    private $start_timestamp = \WPStaging\Vendor\NULL;
    /**
     * Deprecated property @see $this->__wakeup() for details.
     **/
    private $cron = \WPStaging\Vendor\NULL;
    /**
    ...
    {
        if (!\is_a($recurrence, 'WPStaging\\Vendor\\CronExpression')) {
            $recurrence = \WPStaging\Vendor\CronExpression::factory($recurrence);
        }
        ...
        $date = $recurrence->getNextRunDate($start, 0, \true);
    ...
    public function __sleep()
    {
        ...
        return \array_merge($sleep_params, array('start_timestamp', 'cron'));
    }
    /**
