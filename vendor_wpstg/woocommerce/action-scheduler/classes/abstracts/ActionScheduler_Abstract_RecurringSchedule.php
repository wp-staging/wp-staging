 ...
 */
abstract class ActionScheduler_Abstract_RecurringSchedule extends \WPStaging\Vendor\ActionScheduler_Abstract_Schedule
{
    /**
     ...
     * @var DateTime
     */
    private $first_date = \WPStaging\Vendor\NULL;
    /**
     * Timestamp equivalent of @see $this->first_date
     *
     * @var int
     */
    protected $first_timestamp = \WPStaging\Vendor\NULL;
    /**
    ...
    public function __wakeup()
    {
        ...
        if ($this->first_timestamp > 0) {
            $this->first_date = \WPStaging\Vendor\as_get_datetime_object($this->first_timestamp);
        } else {
