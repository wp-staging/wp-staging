...
class ActionMigrator
{
     ...
     */
    public function __construct(\WPStaging\Vendor\ActionScheduler_Store $source_store, \WPStaging\Vendor\ActionScheduler_Store $destination_store, \WPStaging\Vendor\Action_Scheduler\Migration\LogMigrator $log_migrator)
    {
    ...
    public function migrate($source_action_id)
    {
        ...
        try {
            ...
            $last_attempt_date = $status !== \WPStaging\Vendor\ActionScheduler_Store::STATUS_PENDING ? $this->source->get_date($source_action_id) : null;
        ...
        try {
            switch ($status) {
                case \WPStaging\Vendor\ActionScheduler_Store::STATUS_FAILED:
            ...
            if (!\is_a($test_action, 'WPStaging\\Vendor\\ActionScheduler_NullAction')) {
