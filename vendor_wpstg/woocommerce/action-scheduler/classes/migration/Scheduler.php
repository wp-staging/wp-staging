...
class Scheduler
{
    ...
    public function run_migration()
    {
        ...
        if ($count === 0) {
            ...
            $this->schedule_migration(\time() + $this->get_schedule_interval());
        }
    }
    /**
    ...
    public function mark_complete()
    {
        ...
        \WPStaging\Vendor\ActionScheduler_DataController::mark_migration_complete();
    ...
    private function get_migration_runner()
    {
        ...
        return new \WPStaging\Vendor\Action_Scheduler\Migration\Runner($config);
    }
}
