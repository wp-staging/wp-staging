...
use WPStaging\Vendor\ActionScheduler_Logger;
/**
 * Class LogMigrator
 *
...
class LogMigrator
{
     ...
     */
    public function __construct(\WPStaging\Vendor\ActionScheduler_Logger $source_logger, \WPStaging\Vendor\ActionScheduler_Logger $destination_Logger)
    {
