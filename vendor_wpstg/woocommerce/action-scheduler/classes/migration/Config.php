...
use WPStaging\Vendor\ActionScheduler_Logger as Logger;
...
class Config
{
     ...
     */
    public function set_source_store(\WPStaging\Vendor\ActionScheduler_Store $store)
    {
     ...
     */
    public function set_source_logger(\WPStaging\Vendor\ActionScheduler_Logger $logger)
    {
     ...
     */
    public function set_destination_store(\WPStaging\Vendor\ActionScheduler_Store $store)
    {
     ...
     * @param ActionScheduler_Logger $logger
     */
    public function set_destination_logger(\WPStaging\Vendor\ActionScheduler_Logger $logger)
    {
     ...
     */
    public function set_progress_bar(\WPStaging\Vendor\Action_Scheduler\WP_CLI\ProgressBar $progress_bar)
    {
