 ...
 * @since 3.0.0
 */
class ActionScheduler_DBStoreMigrator extends \WPStaging\Vendor\ActionScheduler_DBStore
{
    /**
     ...
     */
    public function save_action(\WPStaging\Vendor\ActionScheduler_Action $action, \DateTime $scheduled_date = null, \DateTime $last_attempt_date = null)
    {
        try {
            /** @var \wpdb $wpdb */
            global $wpdb;
