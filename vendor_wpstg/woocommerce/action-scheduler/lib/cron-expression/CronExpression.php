...
class CronExpression
{
    ...
    */
    public static function factory($expression, \WPStaging\Vendor\CronExpression_FieldFactory $fieldFactory = null)
    {
        $mappings = array('@yearly' => '0 0 1 1 *', '@annually' => '0 0 1 1 *', '@monthly' => '0 0 1 * *', '@weekly' => '0 0 * * 0', '@daily' => '0 0 * * *', '@hourly' => '0 * * * *');
        if (isset($mappings[$expression])) {
            $expression = $mappings[$expression];
        }
        return new self($expression, $fieldFactory ? $fieldFactory : new \WPStaging\Vendor\CronExpression_FieldFactory());
    }
    /**
     ...
     */
    public function __construct($expression, \WPStaging\Vendor\CronExpression_FieldFactory $fieldFactory)
    {
    ...
    {
        return $this->getRunDate($currentTime, $nth, \true, $allowCurrentDate);
    }
    /**
