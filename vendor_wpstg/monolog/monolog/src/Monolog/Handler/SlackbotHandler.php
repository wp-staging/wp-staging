 ...
 */
class SlackbotHandler extends \WPStaging\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WPStaging\Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
