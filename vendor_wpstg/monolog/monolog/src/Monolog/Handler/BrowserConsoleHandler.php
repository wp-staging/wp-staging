 ...
 */
class BrowserConsoleHandler extends \WPStaging\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WPStaging\Vendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
