...
use WPStaging\Vendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \WPStaging\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \WPStaging\Vendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
