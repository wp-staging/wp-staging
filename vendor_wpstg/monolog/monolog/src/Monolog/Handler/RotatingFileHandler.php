 ...
 */
class RotatingFileHandler extends \WPStaging\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \WPStaging\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \WPStaging\Vendor\Monolog\Utils::canonicalizePath($filename);
