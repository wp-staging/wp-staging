...
use WPStaging\Vendor\RollbarNotifier;
use Exception;
 ...
 */
class RollbarHandler extends \WPStaging\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Rollbar notifier
     *
    ...
    protected $levelMap = array(\WPStaging\Vendor\Monolog\Logger::DEBUG => 'debug', \WPStaging\Vendor\Monolog\Logger::INFO => 'info', \WPStaging\Vendor\Monolog\Logger::NOTICE => 'info', \WPStaging\Vendor\Monolog\Logger::WARNING => 'warning', \WPStaging\Vendor\Monolog\Logger::ERROR => 'error', \WPStaging\Vendor\Monolog\Logger::CRITICAL => 'critical', \WPStaging\Vendor\Monolog\Logger::ALERT => 'critical', \WPStaging\Vendor\Monolog\Logger::EMERGENCY => 'critical');
    /**
     ...
     */
    public function __construct(\WPStaging\Vendor\RollbarNotifier $rollbarNotifier, $level = \WPStaging\Vendor\Monolog\Logger::ERROR, $bubble = \true)
    {
