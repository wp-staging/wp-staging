...
@\trigger_error('The ' . __NAMESPACE__ . '\\BsdFindAdapter class is deprecated since Symfony 2.8 and will be removed in 3.0. Use directly the Finder class instead.', \E_USER_DEPRECATED);
 ...
 */
class BsdFindAdapter extends \WPStaging\Vendor\Symfony\Component\Finder\Adapter\AbstractFindAdapter
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \in_array($this->shell->getType(), array(\WPStaging\Vendor\Symfony\Component\Finder\Shell\Shell::TYPE_BSD, \WPStaging\Vendor\Symfony\Component\Finder\Shell\Shell::TYPE_DARWIN)) && parent::canBeUsed();
    }
    /**
     * {@inheritdoc}
     */
