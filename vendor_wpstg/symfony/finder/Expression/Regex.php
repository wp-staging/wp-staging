...
@\trigger_error('The ' . __NAMESPACE__ . '\\Regex class is deprecated since Symfony 2.8 and will be removed in 3.0.', \E_USER_DEPRECATED);
/**
 * @author Jean-François Simon <contact@jfsimon.fr>
 */
class Regex implements \WPStaging\Vendor\Symfony\Component\Finder\Expression\ValueInterface
{
    const START_FLAG = '^';
    const END_FLAG = '$';
    const BOUNDARY = '~';
    ...
    {
        return \WPStaging\Vendor\Symfony\Component\Finder\Expression\Expression::TYPE_REGEX;
    }
    /**
     * {@inheritdoc}
     */
