 ...
 */
namespace WPStaging\Vendor\Symfony\Component\Finder\Shell;

@\trigger_error('The ' . __NAMESPACE__ . '\\Command class is deprecated since Symfony 2.8 and will be removed in 3.0.', \E_USER_DEPRECATED);
/**
...
class Command
{
    ...
    public function __construct(\WPStaging\Vendor\Symfony\Component\Finder\Shell\Command $parent = null)
    {
        $this->parent = $parent;
    }
    /**
     ...
     * @return self
     */
    public static function create(\WPStaging\Vendor\Symfony\Component\Finder\Shell\Command $parent = null)
    {
    ...
    public function join()
    {
        return \implode(' ', \array_filter(\array_map(function ($bit) {
            return $bit instanceof \WPStaging\Vendor\Symfony\Component\Finder\Shell\Command ? $bit->join() : ($bit ?: null);
