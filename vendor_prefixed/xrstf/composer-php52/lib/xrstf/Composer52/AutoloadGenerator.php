 ...
 */
namespace WPStaging\Vendor\xrstf\Composer52;

use WPStaging\Vendor\Composer\Autoload\AutoloadGenerator as BaseGenerator;
use WPStaging\Vendor\Composer\Autoload\ClassMapGenerator;
use WPStaging\Vendor\Composer\Config;
use WPStaging\Vendor\Composer\Installer\InstallationManager;
use WPStaging\Vendor\Composer\Package\AliasPackage;
use WPStaging\Vendor\Composer\Package\PackageInterface;
use WPStaging\Vendor\Composer\Repository\InstalledRepositoryInterface;
use WPStaging\Vendor\Composer\Util\Filesystem;
class AutoloadGenerator extends \WPStaging\Vendor\Composer\Autoload\AutoloadGenerator
{
    /**
     * @var bool
     */
    ...
    public function dump(\WPStaging\Vendor\Composer\Config $config, \WPStaging\Vendor\Composer\Repository\InstalledRepositoryInterface $localRepo, \WPStaging\Vendor\Composer\Package\PackageInterface $mainPackage, \WPStaging\Vendor\Composer\Installer\InstallationManager $installationManager, $targetDir, $scanPsr0Packages = \false, $suffix = '')
    {
        if ($this->classMapAuthoritative) {
            // Force scanPsr0Packages when classmap is authoritative
            $scanPsr0Packages = \true;
        }
        $filesystem = new \WPStaging\Vendor\Composer\Util\Filesystem();
...
EOF;
        ...
        \file_put_contents($targetDir . '/autoload_real_52.php', $this->getAutoloadRealFile(\true, (bool) $includePathFile, $targetDirLoader, $filesCode, $vendorPathCode, $appBaseDirCode, $suffix, $useGlobalIncludePath, $prependAutoloader));
    ...
    protected function getIncludePathsFile(array $packageMap, \WPStaging\Vendor\Composer\Util\Filesystem $filesystem, $basePath, $vendorPath, $vendorPathCode, $appBaseDirCode)
    {
        $includePaths = array();
