...
<div id="wpstg-existing-snapshots">
    ...
    <?php foreach ($snapshots as $snapshot): ?>
        <div id="<?php echo $snapshot->getId() ?>" class="wpstg-clone">
            <?php echo apply_filters('wpstg_before_snapshot_buttons', $html = '', $snapshot) ?>
            ...
            <a href="#" class="wpstg--snapshot--export wpstg-merge-clone wpstg-clone-action"
               ...
               title="<?php _e('Download snapshot as sql file for backup purposes', 'wp-staging') ?>">
            ...
            <a href="#" class="wpstg--snapshot--edit wpstg-clone-action"
               ...
               title="<?php _e('Edit snapshot name and / or notes', 'wp-staging') ?>">
                <?php _e('Edit', 'wp-staging') ?>
            </a>

            <?php echo apply_filters('wpstg_after_snapshot_buttons', $html = '', $snapshot) ?>
            <div class="wpstg-staging-info">
                <ul>
                    ...
                    <?php if ($snapshot->getNotes()):?>
                        <li>
                            <strong><?php _e('Notes:', 'wp-staging') ?></strong>
