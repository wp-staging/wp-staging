...
<div class="wpstg-color-mode-container">
    ...
    <div class="wpstg-system-mode-container <?php echo ($defaultColorMode === 'system') ? 'active' : '';?>">
        <label for="wpstg-system-mode-button" class="wpstg-system-mode-title" title="Switch to OS Default Mode">
    ...
    <div class="wpstg-light-mode-container <?php echo ($defaultColorMode === 'light') ? 'active' : '';?>">
        <label for="wpstg-light-mode-button" class="wpstg-light-mode-title" title="Switch to Lite Mode">
    ...
    <div class="wpstg-dark-mode-container <?php echo ($defaultColorMode === 'dark') ? 'active' : '';?>">
        <label for="wpstg-dark-mode-button" class="wpstg-dark-mode-title" title="Switch to Dark Mode">
