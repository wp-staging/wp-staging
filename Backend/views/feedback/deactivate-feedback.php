...
$reasons = [
    ...
    2 => '<li><label><input type="radio" name="wpstg_disable_reason" value="missing feature"/>' . esc_html__('Miss a feature', 'wp-staging') . '</label></li>
		<li><input type="text" name="wpstg_disable_text[]" value="" placeholder="Please describe the feature"/></li>',
    3 => '<li><label><input type="radio" name="wpstg_disable_reason" value="technical issue"/>' . esc_html__('Technical Issue', 'wp-staging') . '</label></li>
    ...
    4 => '<li><label><input type="radio" name="wpstg_disable_reason" value="other plugin"/>' . esc_html__('Switched to another plugin/staging solution', 'wp-staging') . '</label></li>
		<li><input type="text" name="wpstg_disable_text[]" value="" placeholder="Name of the plugin"/></li>',
    5 => '<li><label><input type="radio" name="wpstg_disable_reason" value="other"/>' . esc_html__('Other reason', 'wp-staging') . '</label></li>
