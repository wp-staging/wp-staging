    ...
    <div class="wpstg-form-group">
        <form class="wpstg-provider-settings-form" id="wpstg-provider-settings-form" method="post">
            ...
            <fieldset class="wpstg-fieldset">
                ...
                <span>/</span><input id="wpstg-storage-provider-<?php echo esc_attr($providerId); ?>-folder-name" class="wpstg-form-control" type="text" style="min-width:300px;" placeholder="/backups" name="folder_name" value="<?php echo esc_attr($folderName); ?>" />
            </fieldset>
            <hr/>
