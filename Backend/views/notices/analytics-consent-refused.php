    ...
    <p><?php echo
        wp_kses_post(
            sprintf(
                ...
                __('WP STAGING will not send usage information about how you use the plugin. If you want an improved technical support experience, you can always re-enable this on <a href="%s">WP STAGING Settings</a> page.', 'wp-staging'),
