...
<?php if (!defined('WPSTGPRO_VERSION')) { ?>
    <div id="wpstg-sidebar">
        <div style="text-align: center;">
            <span style="display:block;margin-bottom: 20px;color:#abc116;">
                <a href="https://wordpress.org/support/plugin/wp-staging/reviews/?filter=5" target="_blank" rel="external noopener" style="text-decoration: none;color:#abc116;">Give Feedback ★★★</a>
            </span>
        </div>
