...
class I18n
{
    public function getTranslations(): array
    {
        ...
        return [
            ...
            'cancel_modal_wait_text'                              => esc_html__('Current job was cancelled from another page! This modal will close automatically when done...', 'wp-staging'),
            ...
            'backup_storages'                                     => [
                ...
                'clicked_cloud_restore_download_body_text'            => esc_html__('The backup file has been saved to your website server.', 'wp-staging'),
                'clicked_cloud_restore_download_modal_title'          => esc_html__('Remote Backup Retrieved Successfully.', 'wp-staging'),
                'file_size_label'                                     => esc_html__('File Size:', 'wp-staging'),
                'download_to_local_device'                            => esc_html__('Download to Local Device', 'wp-staging'),
                'download_body_template'                              => '{bodyText}<br><br>{fileSizeLabel} {fileSize}<div class="wpstg-download-action-buttons"><a href="{downloadUrl}" class="wpstg-button wpstg-blue-primary wpstg-download-to-computer">{downloadButtonText}</a></div>',
