...
class I18n
{
    public function getTranslations(): array
    {
        ...
        return [
            ...
            'confirm_overwrite_checkbox'                          => esc_html__('I understand this will overwrite data on the target site.', 'wp-staging'),
            'destructive_warning'                                 => esc_html__('This will overwrite the selected items on the target site and can\'t be undone.', 'wp-staging'),
            'selected_items'                                      => esc_html__('Selected items:', 'wp-staging'),
            'from_label'                                          => esc_html__('From', 'wp-staging'),
            'to_label'                                            => esc_html__('To', 'wp-staging'),
            'target_badge'                                        => esc_html__('Target', 'wp-staging'),
