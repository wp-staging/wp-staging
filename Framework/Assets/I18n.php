    ...
    public function getTranslations(): array
    {
        ...
        return [
            ...
            'backup_explore'                                      => [
                ...
                'extract_upsell_subtitle'       => esc_html__('Single-file extraction is available on all Pro plans. Multiple files or folders require the Developer or Agency plan.', 'wp-staging'),
                'extract_upsell_feature1_title' => esc_html__('Single files', 'wp-staging'),
                'extract_upsell_feature1_desc'  => esc_html__('Available on all Pro plans.', 'wp-staging'),
                ...
                'extract_upsell_cta_secondary'  => esc_html__('Choose Pro for single-file extraction', 'wp-staging'),
