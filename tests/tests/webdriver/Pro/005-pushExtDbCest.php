...
class pushingExternalDatabaseCest
{
    ...
    {
	    $I->waitForText('Database: external', 10);
        $I->see('Directory: /var/www/single_tests/staging/');
    }
    ...
    {
    	$I->waitForText('Database: external', 10);
        $I->see('Directory: /var/www/multi_tests/staging/');
    }
