...
$description = $setupMode === 'create'
    ? esc_html__('Choose how WP STAGING transfers the selected data.', 'wp-staging')
    : sprintf(esc_html__('Choose how WP STAGING transfers the selected data for this %s.', 'wp-staging'), $setupMode);
...
$renderer->accordionSection([
    ...
    'title'           => __('Transfer method', 'wp-staging'),
