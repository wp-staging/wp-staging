...
<div class="wpstg-remote-sync-settings wpstg-max-w-3xl wpstg-py-2">
    ...
    <header class="wpstg-mb-8">
        ...
        <nav class="wpstg-flex wpstg-items-center wpstg-gap-1 wpstg-text-sm wpstg-text-gray-500 dark:wpstg-text-gray-400" aria-label="<?php echo esc_attr__('Breadcrumb', 'wp-staging'); ?>">
            <span class="hover:wpstg-text-gray-900 dark:hover:wpstg-text-gray-200 wpstg-transition-colors"><?php echo esc_html('WP Staging'); ?></span>
            ...
            <span class="wpstg-font-medium wpstg-text-gray-900 dark:wpstg-text-gray-100"><?php esc_html_e('Remote Sync Connection Key', 'wp-staging'); ?></span>
        </nav>
    </header>
