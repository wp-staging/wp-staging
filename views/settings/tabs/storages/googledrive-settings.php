...
<fieldset>
    ...
    <div class="wpstg-form-group">
        ...
        if ($isGoogleDriveAuthenticated) {
            ...
            ?>
            <a href="<?php echo esc_url($authURL); ?>" class="wpstg-btn-google"> <img class="wpstg--dashicons" src="<?php echo esc_url(WPSTG_PLUGIN_URL . 'assets/svg/google-sign-in.svg'); ?>" alt="<?php esc_attr_e("Sign in with Google", "wp-staging") ?>"/></a>
        ...
        <form class="wpstg-provider-settings-form" id="wpstg-provider-settings-form" method="post" style="<?php echo esc_attr($displayStyle); ?>">
                ...
                <fieldset class="wpstg-fieldset">
                    ...
                    <div class="wpstg-with-icon">
                        ...
                        <a href="javascript:void(0);" class="wpstg-fieldset-icon" onclick="WPStaging.copyTextToClipboard(this)" data-wpstg-source="#wpstg-google-redirect-uri">
                            <img class="wpstg--dashicons" src="<?php echo esc_url(WPSTG_PLUGIN_URL . 'assets/svg/copy.svg'); ?>" alt="<?php esc_html_e("Copy to Clipboard", 'wp-staging') ?>" title="<?php esc_html_e("Copy to Clipboard", 'wp-staging') ?>" />
                        </a>
                    </div>
                </fieldset>
            </div>
            ...
            <div id="wpstg-save-settings-form">
                ...
                <div class="wpstg-storage-provider-action-container">
                    <button type="button" id="wpstg-btn-save-provider-settings" class="wpstg-button wpstg-blue-primary"><?php esc_html_e("Save Settings", "wp-staging") ?></button><?php require_once WPSTG_VIEWS_DIR . "settings/tabs/storages/last-saved-notice.php"; ?>
                </div>
            </div>
        </form>
    </div>
