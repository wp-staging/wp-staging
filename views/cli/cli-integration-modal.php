        ...
        <div class="wpstg-cli-modal-main">
            ...
            <div class="wpstg-cli-install-steps wpstg--steps wpstg--steps--slider" data-wpstg-current-step="1">
                ...
                <div class="wpstg-cli-step wpstg--step is-active" data-wpstg-step="1">
                    ...
                    <div class="wpstg-cli-tab-content" data-tab-content="mac" role="tabpanel" style="display: none;">
                        ...
                        $osId      = 'mac';
                        $cmdFull   = $cmdBashFull;
                        $cmdMasked = $cmdBashMasked;
                        require WPSTG_VIEWS_DIR . 'cli/_partials/command-terminal.php';
                        ?>
                    </div>
                    ...
                    <div class="wpstg-cli-tab-content" data-tab-content="windows" role="tabpanel" style="display: none;">
                        ...
                        $osId      = 'ps';
                        $cmdFull   = '& ([scriptblock]::Create((irm https://wp-staging.com/install.ps1)))' . $licenseFlagPs;
                        $cmdMasked = '& ([scriptblock]::Create((irm https://wp-staging.com/install.ps1)))' . $licenseFlagPsMasked;
                        require WPSTG_VIEWS_DIR . 'cli/_partials/command-terminal.php';
                        ?>
                        ...
                        $osId      = 'cmd';
                        $cmdFull   = 'curl -fsSL https://wp-staging.com/install.cmd -o install.cmd && install.cmd' . $licenseFlagCmd . ' && del install.cmd';
                        $cmdMasked = 'curl -fsSL https://wp-staging.com/install.cmd -o install.cmd && install.cmd' . $licenseFlagCmdMasked . ' && del install.cmd';
                        require WPSTG_VIEWS_DIR . 'cli/_partials/command-terminal.php';
                        ?>
                    </div>
                </div>
                    ...
                    <div class="wpstg-cli-terminal wpstg-w-full wpstg-rounded-xl wpstg-overflow-hidden wpstg-bg-terminal-bg">
                        ...
                        <div class="wpstg-cli-terminal-body wpstg-px-4 wpstg-py-3">
                            ...
                            <div class="wpstg-flex wpstg-items-center wpstg-gap-2 wpstg-text-sm wpstg-font-medium wpstg-font-mono wpstg-text-terminal-success">
                                <?php require WPSTG_VIEWS_DIR . 'cli/_partials/icons/success-check.php'; ?>
            ...
            <div class="wpstg-cli-modal-footer">
                <a href="<?php echo esc_url(Language::localizeDocsUrl('https://wp-staging.com/docs/set-up-wp-staging-cli/')); ?>" target="_blank" rel="noreferrer noopener" class="wpstg-cli-docs-link">
                    ...
                    <?php require WPSTG_VIEWS_DIR . 'cli/_partials/icons/external-link.php'; ?>
                </a>
