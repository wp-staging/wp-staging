            ...
            <div class="wpstg-dropdown wpstg-action-dropdown">
                ...
                <div class="wpstg-dropdown-menu">
                    <?php if (!$legacy && !$corrupt) : ?>
                        <a href="#" class="wpstg-clone-action wpstg--cloud--backup--restore" data-id="<?php echo esc_attr($storageProviderName . "-" . $sanitizedId) ?>" data-file="<?php echo esc_attr($id); ?>" data-name="<?php echo esc_attr($name) ?>" data-storageProviderName="<?php echo esc_attr($storageProviderName) ?>" data-size="<?php echo esc_attr($size) ?>" data-title="<?php esc_attr_e('Restore and overwrite the current site with the contents of this backup.', 'wp-staging') ?>" title="<?php esc_attr_e('Restore and overwrite current website according to the contents of this backup.', 'wp-staging') ?>">
                    ...
                    <?php endif ?>
                    <a href="#" class="wpstg--cloud--backup--download wpstg-merge-clone wpstg-clone-action" data-id="<?php echo esc_attr($storageProviderName . "-" . $sanitizedId) ?>" data-file="<?php echo esc_attr($id); ?>" data-name="<?php echo esc_attr($name) ?>" data-storageProviderName="<?php echo esc_attr($storageProviderName) ?>" data-size="<?php echo esc_attr($size) ?>" title="<?php esc_attr_e('Download backup file to server or local computer', 'wp-staging') ?>">
                        <div class="wpstg-dropdown-item-icon">
