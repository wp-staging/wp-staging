...
<div id="wpstg--modal--remote-upload" data-confirmButtonText="<?php esc_attr_e('Start Upload', 'wp-staging') ?>" style="display: none">
    <h3 class="wpstg--swal2-title wpstg-w-100" for="wpstg-backup-name-input"><?php esc_html_e('Upload Backup to Cloud Storage(s)', 'wp-staging') ?></h3>
    <div class="wpstg-advanced-options wpstg-remote-upload-form wpstg-u-text-left">
