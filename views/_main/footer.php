...
<div class="wpstg-admin-footer">
    ...
    <?php $wpstgOnboarding = FreeOnboarding::resolve(); ?>
    <?php if ($wpstgOnboarding !== null && $wpstgOnboarding->canRestart()) : ?>
        <span class="wpstg-admin-footer-sep" aria-hidden="true">&middot;</span>
        <a class="wpstg-admin-footer-link" href="<?php echo esc_url(admin_url('admin.php?page=wpstg_clone')); ?>" data-wpstg-onboarding-restart><?php esc_html_e('Simple mode', 'wp-staging'); ?></a>
    <?php endif; ?>
</div>
<?php
