...
<div id="wpstg-faq" class="wpstg-block">
    ...
    <ul>
        ...
        <li><a href="https://wp-staging.com/docs/pagebuilders-do-not-work/" target="_blank" rel="external"><?php esc_html_e("Pagebuilder plugin does not open (Divi, Elementor)", "wp-staging") ?></a></li>
        ...
        <div class="wpstg-social-row">
            ...
            <div class="wpstg-social-col">
                <div class="wpstg-share-button">
                    <a href="https://x.com/intent/follow?ref_src=twsrc%5Etfw&region=follow_link&screen_name=wpstg&tw_p=followbutton" target="_blank">
                        <img class="wpstg--dashicons" src="<?php echo esc_url($this->assets->getAssetsUrl("svg/twitter-x.svg")) ?>" id="twitter-logo-svg" alt="WP STAGING on X" title="Follow us on X">
                    </a>
                </div>
            </div>
            <div class="wpstg-social-col">
                <a href="https://github.com/wp-staging/wp-staging" target="_blank" class="wpstg-share-button">
                    <img class="wpstg--dashicons" src="<?php echo esc_url($this->assets->getAssetsUrl("svg/github-logo.svg")) ?>" id="github-logo-svg" alt="WP STAGING on GitHub" title="Follow us on GitHub">
                </a>
            </div>
        </div>
    </div>
