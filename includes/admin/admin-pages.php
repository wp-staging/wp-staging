...
function wpstg_add_options_link() {
	global $wpstg_parent_page, $wpstg_add_ons_page, $wpstg_add_ons_page2, $wpstg_settings_page, $wpstg_tools_page, $wpstg_clone_page;
        $wpstg_parent_page   = add_menu_page( 'WP-Staging', __( 'WP-Staging', 'wpstg' ), 'manage_options', 'wpstg-clone', 'wpstg-clone', 'dashicons-hammer' );
	$wpstg_clone_page = add_submenu_page('wpstg-clone', __('WP-Staging Jobs', 'wpstg'), __('Jobs', 'wpstg'), 'manage_options', 'wpstg-clone', 'wpstg_clone_page');
        $wpstg_settings_page = add_submenu_page( 'wpstg-clone', __( 'WP-Staging Settings', 'wpstg' ), __( 'Settings', 'wpstg' ), 'manage_options', 'wpstg-settings', 'wpstg_options_page' );
        $wpstg_tools_page = add_submenu_page( 'wpstg-clone', __( 'WP-Staging Tools', 'wpstg' ), __( 'Tools', 'wpstg' ), 'manage_options', 'wpstg-tools', 'wpstg_tools_page' );
...
function wpstg_is_admin_page() {
	...
	if ( 'wpstg-settings' == $currentpage || 'wpstg-addons' == $currentpage || 'wpstg-tools' == $currentpage || 'wpstg-clone' == $currentpage) {
