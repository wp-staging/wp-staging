...
class Repair extends AbstractTemplateComponent
{
    ...
    public function ajaxFixOption()
    {
        ...
        $corruptedOption = $this->sites->getRawStagingSitesOption();
    ...
    private function backupOldOption(string $corruptedOption): bool
    {
        return add_option(Sites::CORRUPTED_STAGING_SITES_BACKUP_PREFIX . time(), $corruptedOption, '', false);
    }
    ...
    private function initiateEmailNotification(string $corruptedOption, bool $fixed = false): bool
    {
